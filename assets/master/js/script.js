...
function _populateFileField(_button, variable) {
    var selectedFile = [];
    for (var i = 0; i < _button.get(0).files.length; ++i) {
        selectedFile.push(_button.get(0).files[i].name + '<br>');
    }
    variable.nameField.html(selectedFile);
}
