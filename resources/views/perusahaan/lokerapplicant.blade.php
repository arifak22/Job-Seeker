                    ...
                    <div class="tabs-box">
                      ...
                      <div class="aplicants-upper-bar">
                        ...
                        <ul class="aplicantion-status tab-buttons clearfix">
                          <li class="tab-btn active-btn totals" data-tab="#totals">Total(s): {{count($data)}}</li>
                      ...
                      <div class="tabs-content">
                        ...
                        <div class="tab active-tab" id="totals">
                          <div class="row">
                            ...
                            <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12" onclick="location.href='{{url('menu/pencarikerja-detil?id='.$d->id_profil)}}';" style="cursor: pointer;">
                              <div class="inner-box">
                                <div class="content">
                                  <figure class="image"><img src="{{$d->foto ? Sideveloper::storageUrl($d->foto) : url('assets/images/resource/company-2.png')}}" alt=""></figure>
                                  <h4 class="name"><a href="#">{{$d->nama}}</a></h4>
                                  <ul class="candidate-info">
                                    <li class="designation">{{$d->pendidikan_terakhir}} - {{$d->jurusan}}</li>
                                    <li><span class="icon flaticon-map-locator"></span> {{$d->kecamatan}}, {{$d->kelurahan}} </li>
                                    {{-- <li><span class="icon flaticon-money"></span> $99 / hour</li> --}}
                                  </ul>
                                  <ul class="post-tags">
                                    @foreach(DB::table('vchoice_pencari_kerja')->where('id_tipe','2')->where('id_profil',$d->id_profil)->get() as $s)
