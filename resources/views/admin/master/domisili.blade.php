 ...
 <section class="user-dashboard">
            ...
            <div class="tabs-box">
              ...
              <div class="widget-content">
                ...
                <form class="default-form" id="myform">
                    ...
                    {!!Sideveloper::formInput('Nama Kecamatan','text','name')!!}
  ...
  <script>
    ...
    var tableList = $('#table_id').DataTable({
        ...
        // order        : [[2,'desc']],
        ajax         : {
            url  : "{{url('api/admin/master-kecamatan')}}",
            type : "get",   
            headers: {
                ...
                render: function ( data, type, row, meta ) {
                    return `<div class="option-box">
                              <ul class="option-list">
                                <li><button data-text="Master Kelurahan" onclick="kelurahan(${data})"><span class="la la-eye"></span></button></li>
    ...
    function kelurahan(id){
      var url = "{{url('admin/master-kelurahan?')}}id="+id;
    ...
    function hapus(id){
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    method: "POST",
                    url:  "{{url('api/admin/master-kecamatan-hapus')}}",
                    headers: {
                        "Authorization": "Bearer " + localStorage.getItem('jwt_token')
                    },
    ...
    function ubah(id){
        ...
        $.ajax({
            method: "GET",
            url:  "{{url('api/admin/master-kecamatan-detil')}}",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem('jwt_token')
            },
            data: { id: id, _token: "{{ csrf_token() }}" }
        ...
        .done(function(res) {
            ...
            $("#alert").html(`<div style="position: relative;background: #F0F5F7;border-radius: 8px;padding:5px;">
                   <b class="blinking" style="color:#d62727"> Merubah Data ini akan merubah Kecamatan yang sudah di pilih Perusahaan, Pelamar Kerja & Loker </b>
                </div>
                <br>`);
    ...
    $('#submit').click(function(e) {
        ...
        apiLoading(true, btn);
        form.ajaxSubmit({
            url    : "{{url('api/admin/master-kecamatan-post')}}",
            type   : 'POST',
            headers: {
                "Authorization": "Bearer " + localStorage.getItem('jwt_token')
            },
