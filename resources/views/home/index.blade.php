  ...
  <div class="tab-menu__wrapper">
    ...
    <section id="section-1" class="about-section-two style-two layout-pt-150 layout-pb-60 js-tab-menu-content">
      <div class="auto-container">
        <div class="row grid-base justify-content-between align-items-center">
          <!-- Content Column -->
          <div class="content-column col-xl-4 col-lg-5 col-md-12 col-sm-12 order-2 order-lg-1" style="margin-bottom:0px">
            <div class="inner-column -no-padding wow fadeInLeft">
              ...
              <ul class="list-style-one mt-24 mb-24">
                <li> 1. surat permohonan ke disnaker untuk penerbitan id cpmi </li>
                <li> 2. surat izin perekrutan pekerja migran indonesia (SIP2MI) </li>
                <li> 3. pas foto 4x6 1 lembar, fotokopi ktp 1 lembar, fotokopi KK 1 lembar, fotokopi paspor 1 lembar, fotokopi ijazah atau akta kelahiran 1 lembar, surat izin keluarga (bermaterai), fotokopi surat keterangan menikah (bagi yg sudah menikah) 1 lembar, surat perjanjian penempatan, fotokopi kartu AK-1 (legalisir) 1 lembar</li>
              </ul>
            </div>
          </div>
        ...
        <div class="row grid-base justify-content-between align-items-center">
          <div class="content-column col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="inner-column -no-padding wow fadeInLeft">
              <div class="">
                <h2 class="fw-700">Selain pelayanan id cpmi .jg ada pelayanan pembuatan  AK1(kartu kuning)</h2>
                <div class="text mt-24" style="max-width: ">
              ...
              <ul class="list-style-one mt-24 mb-24">
                <li> 1. Fotokopi ktp 1 lembar </li>
                <li> 2. Fotokopi ijazah terakhir 1 lembar </li>
                <li> 3. Fotokopi sertifikat keterampilan (jika ada)</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="job-block-three">
            <div class="inner-box">
              <div class="content" style="padding-left:0px">
                ...
                <ul class="job-info">
                  <li><span class="icon flaticon-briefcase"></span> {{$p->jenis_pelatihan}}</li>
                  <li><span class="icon flaticon-map-locator"></span> {{$p->kecamatan}}</li>
                </ul>
              </div>
              <ul class="job-other-info">
                <li class="time">Sumber Dana: {{$p->sumber_dana}}</li>
                <li class="required">Tahun Anggaran {{$p->tahun_anggaran}}</li>
              </ul>
    ...
    <section id="section-3" class="layout-pt-120 layout-pb-60 testimonial-section style-two js-tab-menu-content">
      <div class="auto-container">
        <!-- Sec Title -->
        <div class="sec-title text-center">
          <h2 class="fw-700">Jenis pelayanan</h2>
          <div class="text">Kita memiliki beberapa pelanyanan sebagai berikut:</div>
        </div>
        ...
        <div class="row grid-base">
          ...
          <div class="col-xl-3 col-lg-3 col-md-6">
            <div class="step-item text-center">
              ...
              <h3 class="title"><span class="text-red">01</span></h3>
              <p class="text">Pembinaan sertifikasi halal</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6">
            <div class="step-item text-center">
              ...
              <h3 class="title"><span class="text-red">02</span></h3>
              <p class="text">Pembinaan izin PIRT</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6">
            <div class="step-item text-center">
              ...
              <h3 class="title"><span class="text-red">03</span></h3>
              <p class="text">Pembinaan izin perusahaan industri dan perusahaan kawasan indusri</p>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-3 col-md-6">
            <div class="step-item text-center">
              ...
              <h3 class="title"><span class="text-red">03</span></h3>
              <p class="text">Pembinaan SIINAS ( sistem informasi industri nasional )</p>
            </div>
          </div>
