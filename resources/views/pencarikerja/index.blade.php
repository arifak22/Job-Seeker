        ...
        <div class="col-lg-12">
            ...
            <div class="widget-content">
                ...
                <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                    <div class="content">
                        <figure class="image"><img src="{{url('assets/images/resource/candidate-1.png')}}" alt=""></figure>
                        <h4 class="name"><a href="{{url('assets/#')}}">Darlene Robertson</a></h4>
                        ...
                        <ul class="post-tags">
                        <li><a href="{{url('assets/#')}}">App</a></li>
                        <li><a href="{{url('assets/#')}}">Design</a></li>
                        <li><a href="{{url('assets/#')}}">Digital</a></li>
                        </ul>
                    </div>
                ...
                <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                    <div class="content">
                        <figure class="image"><img src="{{url('assets/images/resource/candidate-2.png')}}" alt=""></figure>
                        <h4 class="name"><a href="{{url('assets/#')}}">Wade Warren</a></h4>
                        <ul class="candidate-info">
                        <li class="designation">UI Designer</li>
                        <li><span class="icon flaticon-map-locator"></span> London, UK</li>
                        <li><span class="icon flaticon-money"></span> $99 / hour</li>
                ...
                <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                    <div class="content">
                        <figure class="image"><img src="{{url('assets/images/resource/candidate-3.png')}}" alt=""></figure>
                        <h4 class="name"><a href="{{url('assets/#')}}">Leslie Alexander</a></h4>
                        <ul class="candidate-info">
                        <li class="designation">UI Designer</li>
                        <li><span class="icon flaticon-map-locator"></span> London, UK</li>
                        <li><span class="icon flaticon-money"></span> $99 / hour</li>
